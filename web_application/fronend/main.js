...
exp.get("/ticket", (req, res) => {
  res.render("pages/ticket", { title: "Квиток",
                                  use_db: USE_DB,
                                  server_port: SERVER_PORT,
                                  add_button: "Купити квиток",
                                  page_id: "1" });
});

// ... для сторінки "Лікарі"
exp.get("/train", (req, res) => {
  res.render("pages/train", { title: "Потяг",
                                use_db: USE_DB,
                                server_port: SERVER_PORT,
...
exp.get("/passenger", (req, res) => {
  res.render("pages/passenger", { title: "Пасажир",
                                 use_db: USE_DB,
                                 server_port: SERVER_PORT,
...
exp.get("/sold_tickets", (req, res) => {
  res.render("pages/sold_tickets", { title: "Продані квитки",
                                       use_db: USE_DB,
                                       server_port: SERVER_PORT,
